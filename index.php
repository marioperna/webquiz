...
{
	myWin=window.open('_login.php', 'webquiz')
	if (myWin) {
		document.getElementById('msg').innerHTML='non chiudere questa finestra fino al termine della prova'
...
<br><br><br><br><br>
<div id="container">
<fieldset id="msg">non chiudere questa finestra fino al termine della prova</fieldset>
<br><p id="chiusa">&nbsp;</p>
</div>
